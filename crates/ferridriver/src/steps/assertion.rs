...
step!(PageHasText {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if !content.contains(&text) {
            return Err(format!("Page does not contain text '{text}'").into());
        }
        Ok(None)
    }
});
...
step!(PageNotHasText {
    ...
    execute(page, caps, _table, _vars) {
        ...
        let content = loc.text_content().await?.unwrap_or_default();
        if content.contains(&text) {
            return Err(format!("Page contains text '{text}' but should not").into());
        }
        Ok(None)
    }
});
...
step!(UrlContains {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if !url.contains(&expected) {
            return Err(format!("URL '{url}' does not contain '{expected}'").into());
        }
        Ok(None)
    }
});
...
step!(UrlExact {
    ...
    execute(page, caps, _table, _vars) {
        ...
        let url = page.url().await.unwrap_or_default();
        if url != expected {
            return Err(format!("URL is '{url}', expected '{expected}'").into());
        }
        Ok(None)
    }
});
...
step!(TitleContains {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if !title.contains(&expected) {
            return Err(format!("Title '{title}' does not contain '{expected}'").into());
        }
        Ok(None)
    }
});
...
step!(TitleExact {
    ...
    execute(page, caps, _table, _vars) {
        ...
        let title = page.title().await.unwrap_or_default();
        if title != expected {
            return Err(format!("Title is '{title}', expected '{expected}'").into());
        }
        Ok(None)
    }
});
...
step!(Visible {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if !visible {
            return Err(format!("'{sel}' is not visible").into());
        }
        Ok(None)
    }
});
...
step!(NotVisible {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if !hidden {
            return Err(format!("'{sel}' is visible but should not be").into());
        }
        Ok(None)
    }
});
...
step!(ContainsText {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if !text.contains(&expected) {
            return Err(format!("'{sel}' text is '{text}', does not contain '{expected}'").into());
        }
        Ok(None)
    }
});
...
step!(NotContainsText {
    ...
    execute(page, caps, _table, _vars) {
        ...
        let text = loc.inner_text().await.map_err(|_| format!("'{sel}' not found"))?;
        if text.contains(&expected) {
            return Err(format!("'{sel}' text '{text}' contains '{expected}' but should not").into());
        }
        Ok(None)
    }
});
...
step!(TextExact {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if text.trim() != expected.trim() {
            return Err(format!("'{sel}' text is '{text}', expected '{expected}'").into());
        }
        Ok(None)
    }
});
...
step!(ValueExact {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if val != expected {
            return Err(format!("'{sel}' value is '{val}', expected '{expected}'").into());
        }
        Ok(None)
    }
});
...
step!(HasAttrValue {
    ...
    execute(page, caps, _table, _vars) {
        ...
        let val = loc.get_attribute(&attr).await
            ...
            .unwrap_or_default();
        if val != expected {
            return Err(format!("'{sel}' attribute '{attr}' is '{val}', expected '{expected}'").into());
        }
        Ok(None)
    }
});
...
step!(HasAttr {
    ...
    execute(page, caps, _table, _vars) {
        ...
        let val = loc.get_attribute(&attr).await
            .map_err(|_| format!("'{sel}' not found"))?;
        if val.is_none() {
            return Err(format!("'{sel}' does not have attribute '{attr}'").into());
        }
        Ok(None)
    }
});
...
step!(NotHasAttr {
    ...
    execute(page, caps, _table, _vars) {
        ...
        let val = loc.get_attribute(&attr).await
            .map_err(|_| format!("'{sel}' not found"))?;
        if val.is_some() {
            return Err(format!("'{sel}' has attribute '{attr}' but should not").into());
        }
        Ok(None)
    }
});
...
step!(HasClass {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if !classes.split_whitespace().any(|c| c == cls) {
            return Err(format!("'{sel}' does not have class '{cls}'").into());
        }
        Ok(None)
    }
});
...
step!(NotHasClass {
    ...
    execute(page, caps, _table, _vars) {
        ...
        let classes = loc.get_attribute("class").await
            ...
            .unwrap_or_default();
        if classes.split_whitespace().any(|c| c == cls) {
            return Err(format!("'{sel}' has class '{cls}' but should not").into());
        }
        Ok(None)
    }
});
...
step!(Enabled {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if !enabled {
            return Err(format!("'{sel}' is disabled").into());
        }
        Ok(None)
    }
});
...
step!(Disabled {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if !disabled {
            return Err(format!("'{sel}' is not disabled").into());
        }
        Ok(None)
    }
});
...
step!(Checked {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if !checked {
            return Err(format!("'{sel}' is not checked").into());
        }
        Ok(None)
    }
});
...
step!(NotChecked {
    ...
    execute(page, caps, _table, _vars) {
        ...
        let checked = loc.is_checked().await.map_err(|_| format!("'{sel}' not found"))?;
        if checked {
            return Err(format!("'{sel}' is checked but should not be").into());
        }
        Ok(None)
    }
});
...
step!(ElementCount {
    ...
    execute(page, caps, _table, _vars) {
        ...
        if actual != expected {
            return Err(format!("Found {actual} '{sel}', expected {expected}").into());
        }
        Ok(None)
    }
});
